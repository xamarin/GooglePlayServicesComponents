...
{
    public static partial class PendingResultsExtensions
    {
//        public static async Task<PendingResult> CanceledPendingResultAsync (this PendingResults api, Android.Gms.Common.Apis.IResult result)
//        {
//            return (await api.CanceledPendingResult (result)).JavaCast<PendingResult> ();
//        }
//
//        public static async Task<PendingResult> CanceledPendingResultAsync (this PendingResults api)
//        {
//            return (await api.CanceledPendingResult ()).JavaCast<PendingResult> ();
//        }
