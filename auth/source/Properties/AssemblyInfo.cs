...
static class __Consts {
    public const string PackageName = "GPS Auth";
    public const string AarPath = "m2repository/com/google/android/gms/play-services-auth/" + __GpsConsts.Version + "/play-services-auth-" + __GpsConsts.Version + ".aar";
}
