...
static class __Consts {
    public const string PackageName = "GPS AppInvite";
    public const string AarPath = "m2repository/com/google/android/gms/play-services-appinvite/" + __GpsConsts.Version + "/play-services-appinvite-" + __GpsConsts.Version + ".aar";
}
