...
static class __Consts {
    public const string PackageName = "Firebase Common";
    public const string AarPath = "m2repository/com/google/firebase/firebase-common/" + __FbConsts.Version + "/firebase-common-" + __FbConsts.Version + ".aar";
}
