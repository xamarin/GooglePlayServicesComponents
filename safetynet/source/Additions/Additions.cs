...
namespace Android.Gms.SafetyNet
{
    ...
    {
        //public static string DecodeJwsResult (this ISafetyNetApiAttestationResponse result, byte[] originalNonce)
        //{
        //    return JWT.JsonWebToken.Decode (result.JwsResult, originalNonce);
        //}

        //public static async Task<bool> ValidateWithGoogle (this ISafetyNetApiAttestationReponse result, string validationApiKey)
        //{
